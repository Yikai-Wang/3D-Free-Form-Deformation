...
这是我们在数据可视化课程的期末project，项目成员包括[何占魁](https://github.com/AaronHeee)，[冉诗菡](https://github.com/Rshcaroline)和[王艺楷](https://github.com/wyk-wyk)。
...
关于project的更详细介绍请参考[这里](https://github.com/wyk-wyk/3D-Free-Form-Deformation/blob/master/report.pdf)。
